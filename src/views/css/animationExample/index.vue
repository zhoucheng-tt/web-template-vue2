...
<template>
  <div class='mainbody'>
    <el-row class="lineOne">
      ...
      <el-row class="item">
        <div class="lineOneMiddle"></div>
      </el-row>
      <el-row class="item"
              style="background-color:black;">
        <div class="lineOneRight">
          <div class="lineOneRight-in"></div>
        </div>
      </el-row>
    </el-row>
    ...
    <el-row class="lineTwo">
      ...
      <el-row class="item">
        <div class="lineTwoMiddle"></div>
      </el-row>
      <el-row class="item">
        <div class="lineTwoRight">
        </div>
      </el-row>
    </el-row>
  </div>
  ...
  .lineOne {
    ...
    .item {
      ...
      .lineOneLeft {
        ...
        height: 100%;
        background: red;
        animation: lineOneLeftAmi 20s infinite;
        -webkit-animation: lineOneLeftAmi 5s infinite;
      }
      @keyframes lineOneLeftAmi {
        0% {
      ...
      @-webkit-keyframes lineOneLeftAmi {
        0% {
          background-color: red;
        }
        50% {
      ...
      .lineOneMiddle {
        ...
        position: absolute;
        animation: lineOneMiddleAmi 5s infinite;
      }
      @keyframes lineOneMiddleAmi {
        0% {
          background: pink;
          left: 0px;
          top: 0px;
